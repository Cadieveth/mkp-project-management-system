...
function SprintValid({ modalOpen, setModalOpen, deleteDataDivision }) {
          ...
          <div>
            ...
            <div className="text-sm mb-5">
              <div className="space-y-2">
                <p>
                  You will delete this data from the database, deleted data
                  cannot be recovered. Are you sure you want to delete this
                  data?
                </p>
              </div>
            </div>
