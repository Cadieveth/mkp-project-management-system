              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-xs inline-flex font-medium bg-slate-700 text-slate-100 rounded-full text-center px-2.5 py-1">
                        All Stories
                      </div>
                      {/* End */}
                    </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-sky-100 text-sky-600 rounded-full text-center px-2.5 py-1">
                        Exciting news
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-amber-100 text-amber-600 rounded-full text-center px-2.5 py-1">
                        Announcement
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-blue-100 text-blue-600 rounded-full text-center px-2.5 py-1">
                        Customer Stories
                      </div>
                      {/* End */}
                    </div>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="text-sm inline-flex font-medium bg-slate-700 text-slate-100 rounded-full text-center px-2.5 py-1">
                        All Stories
                      </div>
                      {/* End */}
                    </div>
