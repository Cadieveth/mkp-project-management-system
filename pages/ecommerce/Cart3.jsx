              ...
              <div className="lg:max-w-[640px] lg:mx-auto">
                ...
                <div className="mb-6 lg:mb-0">
                  ...
                  <header className="mb-6">
                    {/* Title */}
                    <h1 className="text-2xl md:text-2xl text-slate-800 font-bold mb-2">
                      ...
                      <div>
                        ...
                        <ul>
                          ...
                          <li className="flex items-center py-3 border-b border-slate-200">
                            <a
                              className="block mr-2 xl:mr-4 shrink-0"
                              href="#0">
                              <img
                        ...
                        <ul>
                          ...
                          <li className="flex items-center justify-between py-3 border-b border-slate-200">
                            ...
                            <div className="text-sm font-medium text-emerald-600 ml-2">
                              $205
                            </div>
                          </li>
                        </ul>
                        ...
                        <div className="text-sm rounded border border-slate-200 p-3">
                          <div className="flex items-center justify-between space-x-2">
                            ...
                            <div className="flex items-center">
                              ...
                              <div>
                                Ending with{" "}
                                <span className="text-slate-800">2478</span>
                              </div>
                            </div>
                            {/* Expiry */}
