...
function SalesStageAdd({
  ...
  async function addSalesStage() {
    try {
      ...
      const response = await fetch(`${config.api_master}/sales-stage/add`, {
        method: "POST",
        headers,
  ...
  return (
    <ModalBasic
      ...
      title="Add Sales Stage Data">
      <div className="px-5 py-4">
        <div className="space-y-3">
          <div>
            <label className="block text-sm font-medium mb-1" htmlFor="code">
              Sales Stage Code<span className="text-rose-500">*</span>
            </label>
            <input
              id="code"
              ...
              onChange={(e) => setSalesStageCode(e.target.value)}
            />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1" htmlFor="name">
              Sales Stage Name<span className="text-rose-500">*</span>
            </label>
            <input
              id="name"
              className="form-input w-full px-2 py-1"
              ...
              onChange={(e) => setSalesStageName(e.target.value)}
            />
          </div>
          <div>
