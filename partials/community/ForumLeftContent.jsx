        ...
        <div className="md:py-8">
          <div className="flex justify-between items-center md:block">
            ...
            <div className="xl:hidden mb-6">
              <button className="btn md:w-full bg-indigo-500 hover:bg-indigo-600 text-white">
                Create Post
              </button>
            </div>
          </div>
              ...
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a
                    ...
                    href="#0">
                    <svg
                      className="w-3 h-3 shrink-0 fill-current text-emerald-500 mr-3"
                      viewBox="0 0 12 12">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a
                    ...
                    href="#0">
                    <svg
                      className="w-3 h-3 shrink-0 fill-current text-rose-500 mr-3"
                      viewBox="0 0 12 12">
                      <path d="M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z" />
                    </svg>
                    <span className="text-sm font-medium text-slate-600">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a
                    ...
                    href="#0">
                    <svg
                      className="w-3 h-3 shrink-0 fill-current text-amber-500 mr-3"
                      viewBox="0 0 12 12">
                      <path d="M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z" />
                    </svg>
                    <span className="text-sm font-medium text-slate-600">
