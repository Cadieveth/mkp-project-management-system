      ...
      <div className="h-full flex flex-col px-5 py-6">
        ...
        <div className="relative w-full max-w-sm mx-auto bg-slate-800 p-3 rounded-2xl">
          ...
          <div className="relative aspect-[7/4] bg-gradient-to-tr from-indigo-500 to-indigo-400 p-5 rounded-xl overflow-hidden">
            {/* Gradients */}
            <div
              className="absolute left-0 -bottom-1/3 w-[398px] aspect-square"
              aria-hidden="true">
              <svg
                ...
                <circle
                  className="fill-indigo-100 opacity-60"
                  filter="url(#glow-a)"
                  cx="85"
                  cy="85"
                  r="85"
            ...
            <div
              className="absolute right-0 -top-1/3 w-[398px] aspect-square"
              aria-hidden="true">
              <svg
                className="w-full h-full"
                width="398"
                ...
                <circle
                  className="fill-sky-400 opacity-60"
                  filter="url(#glow-b)"
                  cx="85"
                  cy="85"
                  r="85"
        ...
        <div className="grow flex flex-col justify-center mt-3">
          <div className="text-xs text-slate-500 font-semibold uppercase mb-3">
            Details
          </div>
